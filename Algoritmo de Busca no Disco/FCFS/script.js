const blocos = [500, 278, 914, 447, 71, 161, 659, 335];
...
async function criarDesenho() {
    ...
    const pontos = [
        ...
        { x: 130, y: 160, novoBloco: true }, // 278
        { x: 130, y: 150, novoBloco: false },
        { x: 330, y: 130, novoBloco: true }, // 914
        { x: 330, y: 120, novoBloco: false },
        { x: 185, y: 105, novoBloco: true }, // 447
        { x: 185, y: 95,  novoBloco: false },
        { x: 70,  y: 80,  novoBloco: true }, // 71
        { x: 70,  y: 70,  novoBloco: false },
        { x: 100, y: 65,  novoBloco: true }, // 161
        { x: 100, y: 55,  novoBloco: false },
        { x: 245, y: 40,  novoBloco: true }, // 659
        { x: 245, y: 30,  novoBloco: false },
        { x: 145, y: 15,  novoBloco: true }, // 335
        { x: 145, y: 5,   novoBloco: false }
    ];
